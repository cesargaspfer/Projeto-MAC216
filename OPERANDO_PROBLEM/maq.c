...
void exec_maquina(Maquina *m, int n) {
  ...
  for (i = 0; i < n; i++) {
	...
	switch (opc) {
    // Operandos auxiliares usado para analisar dados durante a execução de funções
	  OPERANDO aux, o1, o2;
	case PUSH:
	  empilha(pil, arg);
	  break;
